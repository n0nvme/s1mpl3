...
awful.layout.layouts = {awful.layout.suit.fair, awful.layout.suit.fair.horizontal, awful.layout.suit.floating,
                        awful.layout.suit.tile, awful.layout.suit.tile.left, awful.layout.suit.tile.bottom,
                        awful.layout.suit.tile.top, awful.layout.suit.spiral, awful.layout.suit.spiral.dwindle,
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({"telegram", "chrome", "vscode", "terminal", "spotify", "6", "7", "8", "9"}, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(awful.key({modkey}, "s", hotkeys_popup.show_help, {
    ...
    awful.spawn.with_shell("sh ~/.config/awesome/lock.sh")
end, {
...
{
    rule_any = {
        instance = {"xeyes", "DTA", -- Firefox addon DownThemAll.
...
awful.spawn.with_shell('if (xrdb -query | grep -q "^awesome\\.started:\\s*true$"); then exit; fi;' ..
    ...
    -- list each of your autostart commands, followed by ; inside single quotes, followed by ..
                           'dex --environment Awesome --autostart --search-paths "$XDG_CONFIG_DIRS/autostart:~/.config/autostart"' -- https://github.com/jceb/dex
)
